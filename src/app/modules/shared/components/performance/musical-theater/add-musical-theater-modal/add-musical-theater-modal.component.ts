...
@Component({
	selector: 'app-add-musical-theater-modal',
	templateUrl: './add-musical-theater-modal.component.html'
})

export class AddMusicalTheaterModalComponent implements OnInit {
	...
	ngOnInit() {
		...
		.subscribe(
			...
			err => {
				console.error('SA.musicalTheaterHistory.musicalTheaterHistory-form.component - getFamiliesList', err);
			}
		);
		...
		.subscribe(
			...
			err => {
				console.error('SA.musicalTheaterHistory.musicalTheaterHistory-form.component- getGrades', err);
			}
		);
		...
		this.talentService.getTalent().subscribe(
			...
			err => {
				console.error('SA.musicalTheaterHistory.musical-theater-form.component - getTalent', err);
			}
		);
			...
			this.mtService
				...
				.subscribe(
					(response: any) => {
						...
						this.feedback = 'Musical theater information added';
						//this.form.reset();
					...
					err => {
						...
						this.feedback =
							'Unable to add musical theater information';
